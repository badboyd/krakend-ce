module github.com/badboyd/krakend-ce

go 1.17

require (
	github.com/badboyd/krakend-ratelimit v1.4.1
	...
	github.com/devopsfaith/krakend-ce v1.4.1
...
require (
	...
	github.com/devopsfaith/krakend-influx v1.4.0 // indirect
